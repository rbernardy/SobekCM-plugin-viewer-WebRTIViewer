...
namespace RTI
{
    public class RTI_ItemViewer_Prototyper : iItemViewerPrototyper
    {
        public string ViewerType { get; set; }
        public string ViewerCode { get; set; }
        public string[] FileExtensions { get; set; }

        /// <summary> Constructor for a new instance of the RTI_ItemViewerPrototyper class </summary>
        public RTI_ItemViewer_Prototyper()
        {
            ViewerType = "RTI";
            ViewerCode = "rti";
        }
        ...
        {
            return new RTI_ItemViewer(CurrentItem, CurrentUser, CurrentRequest, Tracer);
        }
    }
}
