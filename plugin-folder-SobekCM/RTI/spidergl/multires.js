...
function MultiResRenderer(gl, cacheSizeInBytes, onLoad)
 {
	...
	// box rendering
	/******************************************************/
	var bvs = sglLoadFile(source_base_url + "spidergl/box.v.glsl");
	var bfs = sglLoadFile(source_base_url + "spidergl/box.f.glsl");
...
MultiResRenderer.prototype = {
	...
	loadImage: function(url)
	{
		...
		{
			case 1:
			    var vs = sglLoadFile(source_base_url + "spidergl/multi.v.glsl");
			    var fs = sglLoadFile(source_base_url + "spidergl/hsh.f.glsl");
			...
			case 2:
			    var vs = sglLoadFile(source_base_url + "spidergl/multi.v.glsl");
			    var fs = sglLoadFile(source_base_url + "spidergl/lrgbptm.f.glsl");
				var prg = new SglProgram(this.gl, [vs], [fs]);
				log(prg.log);
				this._program  = prg;
				break;
			case 3:
			    var vs = sglLoadFile(source_base_url + "spidergl/multi.v.glsl");
			    var fs = sglLoadFile(source_base_url + "spidergl/rgbptm.f.glsl");
				var prg = new SglProgram(this.gl, [vs], [fs]);
				log(prg.log);
				this._program  = prg;
				break;
			case 4:
			    var vs = sglLoadFile(source_base_url + "spidergl/multi.v.glsl");
			    var fs = sglLoadFile(source_base_url + "spidergl/image.f.glsl");
				var prg = new SglProgram(this.gl, [vs], [fs]);
				log(prg.log);
				this._program  = prg;
				break;
